        ...
        <View className="mx-4 mt-5 rounded-xl bg-white p-5">
          ...
          <View className="mt-3 rounded-lg bg-slate-50 p-4">
            <View className="flex-row items-center">
              ...
              <Text className="ml-2 text-[14px] font-medium text-slate-700">
                Filters:
              </Text>
            </View>
            ...
            {/* Type */}
            <View className="mt-3">
              <Text className="mb-2 text-[13px] font-medium text-orange-950">
                Type:
              </Text>
            ...
            <View className="mt-3">
              ...
              <View className="h-10 flex-row items-center justify-between rounded-md border border-emerald-200 bg-white px-3">
          ...
          <View className="rounded-t-3xl bg-white px-5 pb-8 pt-5">
            ...
            <View className="mt-5">
              ...
              <View className="flex-row items-center rounded-xl border border-emerald-300 bg-white px-4">
                <Text className="text-[22px] font-semibold text-slate-700">
                  ₹
                </Text>
